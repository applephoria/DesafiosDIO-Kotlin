...
fun main() {
    ...
    /*Esta função imprime duas mensagens uma de boas vindas na tela, e outra do tipo de cadastro usando o método uppercase() da classe String para converter as strings em maiúsculo.
    ...
    while (menu) { //Se digitar 2 sai do loop ele se torna false
        ...
        val escolha = readLine()
                ...
                when (escolha) {
                                    ...
                                    val tipoCadastro = readLine() //Entrada de dados pelo teclado
                                            ...
                                            when (tipoCadastro) {
                                                ...
                                                "2" -> {
                                                    ...
                                                    println("Cadastro finalizado com sucesso bem vindo a DIO\n")
                                                } //Fim when (tipoCadastro) -> 2
                                                else -> {
                                                    println("Opção inválida. Tente novamente.")
                                                    continue // Retorna o loop novamente
                                                } //Fim else when (tipoCadastro) 
                                            } //Fim da condição when (tipoCadastro) 
                    ...
                    else -> { //Se o usuário digitar outra coisa irá exibir a mensagem  "Opção inválida. Tente novamente.""
                    println("\n--- --- --- --- --- --\n") // Separador 
                    println("Opção inválida. Tente novamente.")
                    continue // Retorna o loop novamente
                    } //Fim else when (escolha) 
        } //Fim when (escolha)
    } // Fim Loop menu 
...
//Marcel "Maçã " Florentino  - 07:59 21/09/2023